...
#define ILI9341_CMD_ADDR ((uint32_t)(0x6C000000 | 0x000007FE))
 ...
 * And if it's A17, then 0x6C0000000 | (0x1<<(17+1)) = 0x60040000;
 */
#define ILI9341_DATA_ADDR ( ( uint32_t ) 0x6C000FFE )   //  LCD Register Select: A10
